...
weapon_data["default"] =
{
	...
	shot_speed = 1200, shot_speed_range = 50, cooldown = 0.10, recoil = 3, kick = 50,
	cof_min = 0, cof_max = 10, cof_growth = 10
}

weapon_data["alt"] =
{
	class = "alt", name = "Plasma Gun", color = color.yellow,
	shot = "plasma",
	sfx_fire = "gunfire2",
	ammo_max = 6, ammo_glyph = "*", reload_time = 1.5,
	shot_speed = 100, shot_speed_range = 0, cooldown = 1, recoil = 30, kick = 218,
...
weapon_data["shotgun"] =
{
	...
	shot_speed = 800, shot_speed_range = 500, shot_count = 8, cooldown = 0.60, recoil = 40, kick = 218,
